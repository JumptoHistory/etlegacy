...
static void GLimp_InitCvars(void)
{
	...
	Cvar_CheckRange(r_ext_multisample, 0, 16, qtrue);
...
/**
* @brief Glimp_GetExtraGLConfigVariables
* @parm[out] glconfigExt
*/
void GLimp_GetExtraGLConfigVariables(glconfigExt_t *glconfigExt)
{
	SDL_GL_GetAttribute(SDL_GL_MULTISAMPLESAMPLES, &glconfigExt->multisampleSamples);
}
